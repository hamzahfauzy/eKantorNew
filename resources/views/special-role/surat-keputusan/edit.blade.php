		...
		<div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Edit Data Surat Keputusan</h2>
                        </div>
                        <div class="body">
                            <form id="form_validation" method="POST" action="{{route('pegawai.surat-keputusan.update')}}" enctype="multipart/form-data">
                            	{{csrf_field()}}
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="tentang" required value="{{old('tentang') ? old('tentang') : $surat->tentang}}">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="tahun" required value="{{old('tahun') ? old('tahun') : $surat->tahun}}">
