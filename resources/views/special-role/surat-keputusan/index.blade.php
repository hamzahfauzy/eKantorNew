            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="pull-left">
                                List Data Surat Keputusan
                            </h2>
                            <div class="pull-right">
                                <a href="{{route('pegawai.surat-keputusan.create')}}" class="btn btn-primary waves-effect">
                                        ...
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$model->tanggal->format('j F Y')}}<br>
                                                        @if($model->lastHistori)
                                                            @if($model->lastHistori->status == 2)
                                                            <a href='{{route("pegawai.surat-keputusan.decline-viewer",$model->lastHistori->id)}}' class="badge {{$bg[$model->lastHistori->status]}}">{{$status[$model->lastHistori->status]}}</a>
                                                            @else
                                                    ...
                                                    <td>{{$model->tahun}}</td>
                                                    <td>
                                                        <a href="{{route('pegawai.surat-keputusan.show',$model->id)}}" target="_blank" class="btn btn-info waves-effect" title="Lihat Surat">
                                                            <i class="material-icons">visibility</i>
                                                            
                                                        </a>

                                                        @if($model->need_action > -1)
                                                        <a href="{{route('pegawai.surat-keputusan.edit',$model->id)}}" class="btn btn-warning waves-effect"  title="Edit Surat">
                                                            <i class="material-icons">create</i>
                                                            
                                                        </a>

                                                        <a href="{{route('pegawai.surat-keputusan.delete')}}" class="btn btn-danger waves-effect" onclick="event.preventDefault();deleteAlert({{$model->id}})"  title="Hapus Surat">
                                                            <i class="material-icons">delete</i>
                                                            
                                                        </a>

                                                        <form id="form-delete-{{$model->id}}" style="display: none;" method="post" action="{{route('pegawai.surat-keputusan.delete')}}">
                                                            {{csrf_field()}}
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="defaultModalLabel">Arsip Surat Keputusan</h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form id="form_validation" method="POST" action="{{route('pegawai.surat-keputusan.arsip')}}">
                                                                    {{csrf_field()}}
                                                                    <input type="hidden" name="id" value="{{$model->id}}">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $model = $histori->suratKeputusan; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($model->hasAction($histori->user_id))
                                                            @if($model->lastHistori->status == 2)
                                                            <a href='{{route("pegawai.surat-keputusan.decline-viewer",$model->lastHistori->id)}}' class="badge {{$bg[$model->hasAction($histori->user_id)->status]}}">{{$status[$model->hasAction($histori->user_id)->status]}}</a>
                                                            @else
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('pegawai.surat-keputusan.accept')}}" class="btn btn-success waves-effect" onclick="event.preventDefault();acceptAlert({{$histori->id}})" title="Acc Surat">
                                                            <i class="material-icons">done</i>
                                                            
                                                        </a>

                                                        <a href="{{route('pegawai.surat-keputusan.decline-editor',$histori->id)}}" class="btn btn-danger waves-effect" title="Tolak Surat">
                                                            <i class="material-icons">clear</i>
                                                            
                                                        </a>

                                                        <form id="form-acc-{{$histori->id}}" style="display: none;" method="post" action="{{route('pegawai.surat-keputusan.accept')}}">
                                                            {{csrf_field()}}
                                                        ...
                                                        <div class="modal fade" id="defaultModal{{$histori->id}}" tabindex="-1" role="dialog">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form id="form_validation" method="POST" action="{{route('pegawai.surat-keputusan.decline')}}">
                                                                            {{csrf_field()}}
                                                                            <input type="hidden" name="id" value="{{$histori->id}}">
                                                                            <div class="form-group form-float">
                                                                                <label>Catatan</label>
                                                        ...
                                                        <div class="modal fade" id="defaultModal{{$model->id}}" tabindex="-1" role="dialog">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form id="form_validation" method="POST" onsubmit="no_agenda.value = indeks.value + '/' + kode.value + '/' + index.value" action="{{route('pegawai.surat-keputusan.set-agenda')}}" enctype="multipart/form-data">
                                                                    <div class="modal-body">
                                                                            {{csrf_field()}}
                                                                            <input type="hidden" name="id" value="{{$model->id}}">
