                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        @else
                                        <iframe src="https://docs.google.com/viewer?url={{$surat->file_surat_fix_url ? Storage::url($surat->file_surat_fix_url) : Storage::url($surat->file_surat_url)}}&embedded=true" style="width: 100%;height: 500px;" frameborder="0"></iframe>
                                        @endif
                                    </div>
                                </div>
                            </div>
