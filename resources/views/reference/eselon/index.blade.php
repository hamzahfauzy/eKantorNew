                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="pull-right">
                                <a href="{{route('reference.eselon.create')}}" class="btn btn-primary waves-effect">
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        {{'',$no=1}}
                                        @foreach($eselon as $model)
                                        <tr>
                                            <td>{{$no++}}</td>
                                            <td>{{$model->nama}}</td>
                                            <td>
                                            	<a href="{{route('reference.eselon.edit',$model->id)}}" class="btn btn-warning waves-effect">
				                                    <i class="material-icons">create</i>
				                                    <span>Edit</span>
				                                </a>

				                                <a href="{{route('reference.eselon.delete')}}" class="btn btn-danger waves-effect" onclick="event.preventDefault();deleteAlert({{$model->id}})">
