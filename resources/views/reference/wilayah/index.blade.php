            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="pull-left">
                                List Data Wilayah Tujuan
                            </h2>
                            <div class="pull-right">
                                <a href="{{route('reference.wilayah.create')}}" class="btn btn-primary waves-effect">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
				                                ...
				                                <a href="{{route('reference.wilayah.delete')}}" class="btn btn-danger waves-effect" onclick="event.preventDefault();deleteAlert({{$model->id}})">
				                                    <i class="material-icons">delete</i>
				                                    <span>Hapus</span>
				                                </a>

				                                <form id="form-delete-{{$model->id}}" style="display: none;" method="post" action="{{route('reference.wilayah.delete')}}">
				                                	{{csrf_field()}}
