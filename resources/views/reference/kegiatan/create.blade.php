            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="{{route('reference.kegiatan.insert')}}">
                            	{{csrf_field()}}
                                <div class="form-group form-float">
                                    <select class="form-control show-tick" name="program_id" required="" data-live-search="true">
                                        <option value="">Pilih Program</option>
                                        @foreach($programs as $program)
                                        <option value="{{$program->id}}" {{old('program_id') == $program->id ? 'selected=""' : '' }}>{{$program->nama}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="kd_kegiatan" required value="{{old('kd_kegiatan')}}">
